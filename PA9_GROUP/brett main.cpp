    ...
    Simple 2D fighter test with a basic stage.

    - Flat ground (matches FLOOR_Y)
    - One floating platform in the middle that players can jump up onto
*/
...
void handlePlatformCollision(Character& player, float prevY, const sf::RectangleShape& platform)
{
    // Platform bounds
